...
class OandaApi:
    ...
    ##Function to make requests to OANDA API
    ...
    #Function which makes a request to a specified endpoint and makes sure it's in the appropriate data key
    ...
    def web_api_candles(self, pair_name, granularity, count):
        ...
        #orient = list (great for graphs)
        #column as key, and then list with all of the values for that particular column
    ...
    def place_trade(self, pair_name: str, units: float, direction: int, 
        ...
        #Rounds order to respective precision
