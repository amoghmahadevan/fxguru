...
class CandlePlot:
    ...
    #To make Graph - Add Figure, Add a trace to figure, Update Axes/Layout
    
    #Function to avoid rangebreaks by only plotting x-axes of times we have in datafram
    ...
    def show_plot(self, width = 825, height = 400, nticks = 5, line_traces = [], sec_traces = []):
